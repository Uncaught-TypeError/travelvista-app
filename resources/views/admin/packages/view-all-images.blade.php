    ...
    <x-slot name="body">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-4">
                <div class="p-5">
                    <a href="{{ route('admin.packages.index') }}" class="bg-gray-400 rounded-lg py-2 px-5 hover:bg-gray-500 font-bold text-white">Back</a>
                </div>
                <span class="flex items-center justify-center text-2xl p-5 mb-3">
                    Image Gallery of Every packages
                </span>
                ...
                <div class="flex items-center justify-center py-4 md:py-8 flex-wrap">
                    <button type="button" class="text-blue-700 hover:text-white border border-blue-600 bg-white hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-full text-base font-medium px-5 py-2.5 text-center mr-3 mb-3 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500 dark:bg-gray-900 dark:focus:ring-blue-800">All packages</button>
