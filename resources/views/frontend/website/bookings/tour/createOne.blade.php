                    ...
                    <div class="py-12">
                        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                            <div class="m-2 flex p-2">
                                <a href="{{ route('bookings.tour.index') }}" class="py-2 text-indigo-500 hover:text-indigo-700">Back</a>
                            </div>
                            <div class="m-2 p-2">
                                ...
                                <div class="space-y-12">
                                    <div class="border-b border-gray-900/10 pb-12">
                                        ...
                                        <p class="mt-1 text-sm leading-6 text-gray-600">These informations are required in order to make a booking.</p>
