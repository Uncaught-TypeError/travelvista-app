        ...
        <section class="mt-28 pt-5 flex flex-col justify-center items-center">
            <div class="px-10">
                ...
                <div class="flex flex-col mb-5">
                    ...
                    <div class="mt-2">
                        <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                            <input type="text" name="" id="" autocomplete="off" class="block flex-1 border-0 bg-transparent py-1.5 pl-2 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="" value="{{ $mergedData['email'] }}" autocomplete="off" disabled />
                        </div>
                    </div>
                </div>
                <div class="flex flex-col mb-5">
                ...
                <div class="flex flex-col mb-5">
                    ...
                    <div class="mt-2">
                        <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 w-full">
                            <input type="text" name="" id="" autocomplete="off" class="block flex-1 border-0 bg-transparent py-1.5 pl-2 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="" value="{{ $mergedData['phone'] }}" autocomplete="off" disabled />
                        </div>
                    </div>
                </div>
                <div>
