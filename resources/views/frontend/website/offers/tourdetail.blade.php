    ...
    <section class="mt-28">
        <div class="p-5 flex justify-around">
            <a href="" class="flex">
                ...
                <span class="uppercase font-roboto text-gray-700">Want to choose desire tour?</span>
            </a>
            <a href="{{ url()->previous() }}">
                <span class="uppercase font-roboto text-gray-700">Back</span>
            </a>
            <a href="" class="flex">
                <span class="uppercase font-roboto text-gray-700">Switch to package?</span>
            ...
            <div class="container justify-center items-center text-center mx-auto flex flex-col px-5 py-10">
                ...
                <div class="mx-auto lg:w-4/6 pt-10">
                    ...
                    <div class="flex justify-evenly items-center p-5">
                        <span class="border p-3 border-black hover:bg-gray-100 rounded-lg cursor-pointer">View {{ $tour->tour_name }} Images</span>
